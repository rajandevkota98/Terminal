...
class Inventory(models.Model):
    ...
    expire_date=models.DateField(default='2014-02-09')
    mfg_date=models.DateField(default='2014-02-09')
...
class CustomerRequest(models.Model):
    ...
    phone=models.CharField(max_length=255)
    Inventory_details=models.CharField(max_length=255)
...
class CompanyAccount(models.Model):
    # choices=((1,"Cash"),(2,"Cheque"),(3,"MobileBanking"))
